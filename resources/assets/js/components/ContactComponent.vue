<template>
    <b-list-group-item href="#" :variant="variant">
        <b-row class="p-2" align-h="center">
            <b-col cols="12" md="3" class="text-center">
                <b-img :src="conversation.contact_image" rounded="circle" width="60" height="60" 
                alt="Foto de perfil" title="Foto de perfil" class="m-1" />
            </b-col>
