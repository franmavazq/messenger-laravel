...
<b-container>
    <b-form class="m-3" action="" method="post" enctype="multipart/form-data">
        ...
        <b-form-group label="Imagen de perfil (sólo si desea modificar):">
            <b-img :src="image" rounded="circle" width="60" height="60" 
                alt="Imagen actual" title="Imagen actual" class="m-1" />
            <b-form-file name="image" placeholder="Seleccionar una nueva imagen" />
        </b-form-group>
